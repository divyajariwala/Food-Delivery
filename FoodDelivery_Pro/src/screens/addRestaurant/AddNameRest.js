      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={{
          ...
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginLeft: wp('-8%') }}>
            <Text style={{ textAlign: 'center', alignSelf: 'center', fontSize: 20, fontFamily: FontFamily.SemiBold, color: '#333f4b' }}>Add Your Restaurant</Text>
          </View>
        </View>
        ...
        <KeyboardAwareScrollView contentContainerStyle={{ flex: 1, }}>
          ...
          <View style={{ flex: 1, justifyContent: 'center', backgroundColor: 'white' }}>
            <Text style={{ fontSize: hp(3), alignSelf: 'center', fontFamily: FontFamily.Bold, color: '#333f4b' }}>Create your MenuDrive account</Text>
            <View style={{ flexDirection: 'row', marginTop: hp('2%'), alignSelf: 'center', }}>
              <Text style={{ fontSize: hp(2.5), color: '#333f4b', fontFamily: FontFamily.Regular }}>Already have an account?</Text>
              <TouchableItem onPress={() => this.props.navigation.navigate('SignIn')}>
                <Text style={{ fontSize: hp(2.5), color: Colors.orangeLight, marginLeft: 5, fontFamily: FontFamily.Regular }}>Log in</Text>
              </TouchableItem>
            </View>
          ...
          /> */}
            ...
            <TouchableItem onPress={() => this.props.navigation.navigate('AddDetailsRest')} style={{ marginLeft: wp('4%'), marginTop: hp(4), width: '89%' }}>
              <Text style={{ textAlign: 'center', fontSize: hp(3), color: 'white', backgroundColor: Colors.primaryColor, padding: 15, borderRadius: 8, height: hp(9),fontFamily:FontFamily.SemiBold }}>Next</Text>
            </TouchableItem>
