...
const slide1Img = require('../../assets/img/onBoard.png');
const slide2Img = require('../../assets/img/onBoard4.png');
const slide3Img = require('../../assets/img/onBoard5.png');
const slide4Img = require('../../assets/img/onBoard2.png');
...
const slides = [
  ...
  },
  {
    ...
    description: 'Browse through menu and review to find the food you like.',
  },
  {
    id: 'slide3',
    img: slide3Img,
      ...
      <SafeAreaView style={styles.screenContainer}>
          ...
          <Swiper
            ...
            {slides.map((item) => (
              <View key={item.id} style={styles.slide}>
                ...
                {/* <View style={[styles.slideImg,{backgroundColor:'#DADADA',}]} /> */}
        ...
        <View style={styles.paginationContainer}>
          ...
          <View style={styles.row}>
            {slides.map((item, i) => (
              <TouchableItem key={i} onPress={this.hopFuction(i)}>
                <View
                  key={`dot_${item.id}`}
                  style={[
                    styles.dot,
