...
const styles = StyleSheet.create({
  ...
  favorite: {
    backgroundColor: Colors.lightBackGroundText,
  },
...
export default class ProductA extends Component {
  constructor(props) {
    ...
    this.state = {
      product: {
        images: [
          require('../../assets/img/pizza_img2.jpg'),
          require('../../assets/img/pizza_img2.jpg'),
          require('../../assets/img/pizza_img2.jpg'),
        ],
        ...
        <ScrollView>
          <View style={styles.swiperContainer}>
            ...
            <View style={[styles.topButton, styles.left]}>
              <TouchableItem onPress={this.navigationToSearch} borderless>
              ...
              <TouchableItem onPress={this.onPressAddToFavorites} borderless>
                <View style={styles.buttonIconContainer}>
                  <Icon
                    ...
                    size={22}
                    color={
                      favorite ? Colors.onSecondaryColor : 'rgba(0,63,95,0.7)'
                    }
                  />
                </View>
              </TouchableItem>
