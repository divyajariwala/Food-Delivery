...
const MORE_ICON = IOS ? 'more-horizontal' : 'more-horizontal';
const EDIT_ICON = IOS ? 'edit' : 'edit';
              ...
              <View style={styles.editButtonContainer}>
                <TouchableItem
                  ...
                  <View style={styles.editButton}>
                    <Icons name={MORE_ICON} size={22} color={Colors.black} />
                  </View>
                </TouchableItem>
              </View>
            </View>
          ...
          <TouchableItem>
            <View style={styles.bottomSheetAction}>
              <View style={styles.bottomSheetIconContainer}>
                <Iconss name={EDIT_ICON} size={22} color={Colors.primaryColor} />
              </View>
