...
const styles = StyleSheet.create({
  ...
  fullAnimate: {
    width: Layout.SCREEN_WIDTH - 32,
    height: Layout.SCREEN_HEIGHT - 80,
    backfaceVisibility: 'hidden'
  },
  creditCardContent: {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView>
          ...
          {this.state.frontCardVisible === true ? <View style={styles.form}>
            <ScrollView
              vertical
        ...
        <View style={styles.buttonContainer}>
          ...
          <Button
            onPress={this.state.frontCardVisible === true ? this.flipCreditCard : this.goBack}
            title={this.state.frontCardVisible === true ? 'Next Step' : 'Save Credit Card'}
