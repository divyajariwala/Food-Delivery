  ...
  constructor(props) {
    ...
    this.state = {
      categories: [
        ...
        {
          key: 2,
          imageUri: require('../../assets/img/grill_cato.jpeg'),
          name: 'Grill',
        },
        {
          key: 3,
      ...
      products: [
        {
          imageUri: require('../../assets/img/pizza_product_img.jpg'),
          name: 'Pizza Carbonara 35cm',
          price: 10.99,
          label: 'new',
        },
        {
          imageUri: require('../../assets/img/toast_img2.jpg'),
          name: 'Breakfast toast sandwich',
          price: 4.99,
        },
        {
          imageUri: require('../../assets/img/cake_2_image.jpg'),
      ...
      popularProducts: [
        {
          imageUri: require('../../assets/img/toast_img.jpeg'),
        ...
        {
          imageUri: require('../../assets/img/home_pizza-img.png'),
          name: 'Pizza Margarita 35cm',
          price: 10.99,
          quantity: 0,
        },
        {
          imageUri: require('../../assets/img/cake_img.jpg'),
          name: 'Chocolate cake',
          price: 4.99,
          quantity: 0,
        },
